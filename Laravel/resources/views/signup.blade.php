...
<head>
    ...
    <style>
        /* Add this to your style.css or in a style tag within the head */
        .input_container {
...
<body style="display: flex;
    ...
    height: 100vh;
    margin: 0;
    background-image: url(assets/Images/HomePage/wedding_showcase.png);
    ...
    <div class="container-login" >
        ...
        <div class="login-form">
            <form method="POST" action="{{ route('register') }}">
                @csrf
                <div class="header">
                    <label class="title" style="font-size: 20px;">Create an account</label>
                    <p class="description">Sign up now and let us bring your dream events to life with stunning decorations!</p>
                </div>

                <div class="input_container">
                    <svg class="icon" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M20 22C20 19.2386 16.4183 16 12 16C7.58172 16 4 19.2386 4 22M12 13C9.23858 13 7 10.7614 7 8C7 5.23858 9.23858 3 12 3C14.7614 3 17 5.23858 17 8C17 10.7614 14.7614 13 12 13Z" stroke="#4F5467" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <input id="name" class="input_field @error('name') is-invalid @enderror" type="text" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Full Name">
                    @error('name')
                ...
                <div class="input_container">
                    ...
                    <input id="email" class="input_field @error('email') is-invalid @enderror" type="email" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="name@mail.com">
                    @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="input_container">
                    ...
                    <input id="password" class="input_field @error('password') is-invalid @enderror" type="password" name="password" required autocomplete="new-password" placeholder="Password">
                    @error('password')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="input_container">
                    ...
                    <input id="password-confirm" class="input_field" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Confirm Password">
                </div>

                <button class="sign-in_btn" type="submit" style="margin-bottom: 15px;">
                    <span>Create account</span>
                </button>
                <p class="description">Already have an account? <a href="{{ route('login') }}">Login</a></p>
            </form>
        </div>
        <div class="testimonial" >
            <p>"We specialize in stunning decorations and seamless event planning to turn your celebrations into
                unforgettable memories."</p>
                
                <div style="height: 5px;"></div>       
            <img src="assets/Images/Brand/main_logo_medium.png" alt="Logo"
                style="width: 150px; max-width: 100%; height: auto; ">
               
            <div class="user" style="bottom: auto;">
                <span class="username" >Festivity</span>
                <span class="occupation">Transforming Moments, Creating Memories!</span>
            </div>
        </div>
    </div>
