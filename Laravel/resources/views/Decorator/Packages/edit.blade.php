        ...
        <div class="main-content-wrap">
            <div class="wg-box">
                ...
                <div class="form-wrapper">
                    <form method="POST" action="{{ route('decorator.packages.update', $package->package_id) }}" class="form-box">
                        @csrf
                        @method('PUT')
                                    ...
                                    @foreach($events as $event)
                                        <div class="checkbox-item">
                                            <input type="checkbox" id="event-{{ $event->event_id }}" name="events[]" value="{{ $event->event_id }}" 
                                                {{ (is_array(old('events')) && in_array($event->event_id, old('events'))) || 
                                                   (empty(old('events')) && in_array($event->event_id, $packageEvents)) ? 'checked' : '' }}>
