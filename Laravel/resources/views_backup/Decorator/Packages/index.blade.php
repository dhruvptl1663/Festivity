...
<div class="main-content-admin">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-5 header-flex">
        ...
        <div>
            <a href="{{ route('decorator.packages.create') }}" class="btn btn-primary rounded-pill shadow-sm">
        ...
        {{ number_format($package->rating, 1) }}
                            ...
                            <div class="d-flex justify-content-end align-items-center">
                                <div class="btn-group gap-2">
                                    <a href="{{ route('decorator.packages.edit', $package->package_id) }}" class="btn btn-icon btn-outline-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Package">
