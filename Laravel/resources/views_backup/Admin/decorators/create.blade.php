        ...
        <div class="col-12 col-xl-10">
            <div class="glass-card p-5 rounded-5">
                <div class="header-bar mb-5">
                    <h1 class="display-5 fw-bold text-purple mb-4">Create New Decorator Profile</h1>
                    <div class="accent-line" style="width: 80px; height: 6px;"></div>
                </div>

                <form action="{{ route('admin.decorators.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                    @csrf
                    
                    <!-- Name Field -->
                    <div class="form-floating mb-5">
                        <input type="text" class="form-control form-control-xl rounded-4 @error('decorator_name') is-invalid @enderror" 
                               id="decorator_name" name="decorator_name" placeholder=" " required
                    ...
                    <div class="form-floating mb-5">
                        ...
                        <label for="password" class="text-muted fs-5">
                            <i class="fas fa-key me-3 fa-lg"></i>Secure Password
                        </label>
                        @error('password')
                            <div class="invalid-feedback ps-5 fs-5">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-5">
                        <label class="form-label text-muted mb-4 fs-5">
                            <i class="fas fa-camera-retro me-3 fa-lg"></i>Profile Image Upload
                        </label>
                        <div class="drop-zone rounded-4 p-5 text-center border-3 dashed-border" style="min-height: 200px;">
                            ...
                            <div class="drop-zone-content">
                                ...
                                <p class="mb-2 fs-5">Drag & drop high-quality photos here</p>
                                <p class="text-muted fs-6">Recommended size: 600x600 pixels (Max 5MB)</p>
                            </div>
                        </div>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="rating-input">
                            <input type="number" step="0.1" 
                                   ...
                                   style="height: 70px; font-size: 1.25rem; padding-left: 2rem;">
                        ...
                        <div class="d-flex align-items-center gap-4">
                            ...
                            <div class="toggle-switch-lg">
                                <input type="checkbox" class="visually-hidden" 
                                       id="availability" name="availability" value="1" checked>
                    ...
                    <div class="d-grid mt-5">
                        <button type="submit" class="btn btn-purple-xl rounded-pill py-4 fs-4">
                            <i class="fas fa-plus-circle me-3 fa-lg"></i>Create Professional Profile
                        </button>
                    </div>
                </form>
            </div>
